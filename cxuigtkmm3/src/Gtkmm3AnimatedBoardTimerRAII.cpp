...
void cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::SetCallback(Callback&& p_callback)
{
...
void cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::SetPeriod(Period&& p_period)
{
...
void cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::Start()
{
...
void cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::Stop()
{
    m_timer.disconnect();
}

cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimerRAII(ITimer::Callback&& p_callback, Period&& p_period)
{
...
cx::ui::cmn::Gtkmm3AnimatedBoardTimerRAII::~Gtkmm3AnimatedBoardTimerRAII()
{

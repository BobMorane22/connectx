...
void cx::ui::gtkmm3::Chip::SetDelegate(std::unique_ptr<IWidget> p_delegate)
{
...
void cx::ui::gtkmm3::Chip::ChangeColor(const cx::model::ChipColor& p_newFillColor)
{
...
cx::model::ChipColor cx::ui::gtkmm3::Chip::GetColor() const
{
    return m_fillColor;
}

void cx::ui::gtkmm3::Chip::Highlight()
{
...
void cx::ui::gtkmm3::Chip::UnHighlight()
{
    m_backgroundColor = m_initialBackgroundColor;
    Redraw();
}

size_t cx::ui::gtkmm3::Chip::GetWidth() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetWidth();
}

size_t cx::ui::gtkmm3::Chip::GetHeight() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetHeight();
}

void cx::ui::gtkmm3::Chip::SetEnabled(cx::cmn::ui::EnabledState p_enabled) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetEnabled(p_enabled);
}

void cx::ui::gtkmm3::Chip::SetMargins(const cx::cmn::ui::Margins& p_newMarginSizes) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetMargins(p_newMarginSizes);
}

void cx::ui::gtkmm3::Chip::SetTooltip(const std::string& p_tooltipContents)
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetTooltip(p_tooltipContents);
}

std::unique_ptr<cx::cmn::ui::ISignal<cx::cmn::ui::EventPropagation, cx::cmn::ui::KeyboardKeyPressedEvent>> cx::ui::gtkmm3::Chip::OnKeyPressed()
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return nullptr;);
    return m_delegate->OnKeyPressed();
}

void cx::ui::gtkmm3::Chip::Redraw()
{
    queue_draw();
}

bool cx::ui::gtkmm3::Chip::on_draw(const Cairo::RefPtr<Cairo::Context>& p_context)
{
    Draw(p_context);
...
void cx::ui::gtkmm3::Chip::Draw(const Cairo::RefPtr<Cairo::Context>& p_context) const
{
...
void cx::ui::gtkmm3::Chip::DrawBackgroundColor(const Cairo::RefPtr<Cairo::Context>& p_context) const
{
    p_context->save();
    DrawBorder(p_context);
...
void cx::ui::gtkmm3::Chip::DrawFillColor(const Cairo::RefPtr<Cairo::Context>& p_context) const
{

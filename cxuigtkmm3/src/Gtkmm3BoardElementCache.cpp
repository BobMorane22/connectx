...
const Cairo::RefPtr<Cairo::Surface>& cx::ui::cmn::Gtkmm3BoardElementCache::Get(const cx::model::ChipColor& p_color) const
{
    size_t index = 0;
...
void cx::ui::cmn::Gtkmm3BoardElementCache::Clear()
{
    m_keys.clear();
    m_surfaces.clear();
}

bool cx::ui::cmn::Gtkmm3BoardElementCache::HasElement(const cx::model::ChipColor& p_color)
{

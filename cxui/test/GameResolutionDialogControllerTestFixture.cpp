...
GameResolutionDialogControllerTestFixture::GameResolutionDialogControllerTestFixture()
{
    ...
    m_controller = std::make_unique<cx::ui::GameResolutionDialogController>(*m_model);
...
cx::ui::IGameResolutionDialogController& GameResolutionDialogControllerTestFixture::GetController()
{
    EXPECT_TRUE(m_controller);
    return *m_controller;
}

...
MainWindowPresenterTestFixture::MainWindowPresenterTestFixture()
{
    ...
    m_presenter = std::make_unique<cx::ui::MainWindowPresenter>(*m_model, *m_model, *m_model, *m_model);
...
cx::ui::IMainWindowPresenter& MainWindowPresenterTestFixture::GetPresenter()
{
    EXPECT_TRUE(m_presenter);
    return *m_presenter;
}

cx::ui::IGameViewPresenter& MainWindowPresenterTestFixture::GetGameViewPresenter()
{
    EXPECT_TRUE(m_presenter);
    return *m_presenter;
}

cx::ui::INewGameViewPresenter& MainWindowPresenterTestFixture::GetNewGameViewPresenter()
{
    EXPECT_TRUE(m_presenter);
    return *m_presenter;
}

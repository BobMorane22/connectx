...
MainWindowControllerTestFixture::MainWindowControllerTestFixture()
{
    ...
    m_controller = std::make_unique<cx::ui::MainWindowController>(*m_model, *m_model);
...
cx::ui::IMainWindowController& MainWindowControllerTestFixture::GetController()
{
...
cx::ui::INewGameViewController& MainWindowControllerTestFixture::GetNewGameViewController()
{
    EXPECT_TRUE(m_controller != nullptr);

...
#*************************************************************************************************
# Makefile to build the 'cxlog' library.
#
# @file Rules.mk
# @date 2020
#
...
#
OBJS_$(d) := $(d)/src/ChainLogger.o \
             $(d)/src/CSVMessageFormatter.o \
             $(d)/src/FileLogTarget.o \
             $(d)/src/IncrementalChainedLogger.o \
             $(d)/src/IncrementalLogger.o \
             $(d)/src/ISO8601TimestampFormatter.o \
             $(d)/src/Logger.o \
...
$(d)/lib$(d).a: $(OBJS_$(d))
	@echo ~~~ Generating the libcxlog.a static library ~~~
	$(ARCHIVE)

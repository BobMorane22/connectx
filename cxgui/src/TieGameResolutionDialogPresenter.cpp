...
std::string cxgui::TieGameResolutionDialogPresenter::GetResolutionMessage() const
{
     return "Nobody wins, nobody looses!";
}

std::string cxgui::TieGameResolutionDialogPresenter::GetStartNewGameButtonText() const
{

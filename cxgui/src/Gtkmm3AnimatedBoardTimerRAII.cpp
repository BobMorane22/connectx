...
cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::Gtkmm3AnimatedBoardTimer()
: m_period{Period{1000.0}}
{
}

void cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::SetCallback(Callback&& p_callback)
{
...
void cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::SetPeriod(Period&& p_period)
{
...
void cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::Start()
{
...
void cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimer::Stop()
{
    m_timer.disconnect();
}

cx::gui::Gtkmm3AnimatedBoardTimerRAII::Gtkmm3AnimatedBoardTimerRAII(ITimer::Callback&& p_callback, Period&& p_period)
{
...
cx::gui::Gtkmm3AnimatedBoardTimerRAII::~Gtkmm3AnimatedBoardTimerRAII()
{

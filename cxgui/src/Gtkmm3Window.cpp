...
void cx::gui::Gtkmm3Window::ConfigureWindowIcon()
{
    try
    {
        set_icon_from_file(cx::gui::RESSOURCE_ICONS_PATH + std::string{"/cxicon16.png"});
    }
...
cx::gui::Gtkmm3Window::Gtkmm3Window(WidgetsFactories& p_widgetsFactories)
...
void cx::gui::Gtkmm3Window::ShrinkToContents(IWindow::Orientation p_orientation)
{
...
void cx::gui::Gtkmm3Window::SetDelegate(std::unique_ptr<IWidget> p_delegate)
{
...
size_t cx::gui::Gtkmm3Window::GetWidth() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetWidth();
}

size_t cx::gui::Gtkmm3Window::GetHeight() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetHeight();
}

void cx::gui::Gtkmm3Window::SetEnabled(EnabledState p_enabled) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetEnabled(p_enabled);
}

void cx::gui::Gtkmm3Window::SetMargins(const Margins& p_newMarginSizes) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetMargins(p_newMarginSizes);
}

void cx::gui::Gtkmm3Window::SetTooltip(const std::string& p_tooltipContents)
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetTooltip(p_tooltipContents);
}

std::unique_ptr<cx::gui::ISignal<cx::gui::EventPropagation, cx::gui::KeyboardKeyPressedEvent>> cx::gui::Gtkmm3Window::OnKeyPressed()
{

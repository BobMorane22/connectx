...
cx::gui::Gtkmm3AboutWindow::Gtkmm3AboutWindow(
...
void cx::gui::Gtkmm3AboutWindow::InitializeWidgets()
{
...
void cx::gui::Gtkmm3AboutWindow::ConfigureWindow()
{
...
void cx::gui::Gtkmm3AboutWindow::RegisterLayouts()
{
    // Nothing to do.
}

void cx::gui::Gtkmm3AboutWindow::RegisterWidgets()
{
...
void cx::gui::Gtkmm3AboutWindow::ConfigureLayouts()
{
    // Nothing to do.
}

void cx::gui::Gtkmm3AboutWindow::ConfigureWidgets()
{
    set_title(m_presenter->GetWindowTitle());
...
void cx::gui::Gtkmm3AboutWindow::ConfigureSignalHandlers()
{

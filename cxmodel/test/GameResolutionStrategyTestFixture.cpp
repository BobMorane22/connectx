...
void GameResolutionStrategyTestFixture::DropChip(size_t p_column,
                                                 ...
                                                 std::vector<cxmodel::IBoard::Position>& p_takenPositions)
{
    DropChipInternal(p_column, p_chip, p_board, p_takenPositions);
}
...
cxmodel::Board GameResolutionStrategyTestFixture::Make9By8Board() const
{
    return cxmodel::Board(9u, 8u, m_model);
}

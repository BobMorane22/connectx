...
constexpr cx::cmn::ui::AnimationSpeed NUMBER_CHIPS_MOVED_PER_SECOND{3u};
...
void cx::cmn::ui::Gtkmm3GameView::Update(cx::cmn::ui::BoardAnimationNotificationContext p_context, cx::cmn::ui::BoardAnimationSubject* p_subject)
{
    IF_CONDITION_NOT_MET_DO(p_subject, return;);

    switch(p_context)
    {
        case cx::cmn::ui::BoardAnimationNotificationContext::ANIMATION_MODEL_VALID:
        {
        ...
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_MOVE_LEFT_ONE_COLUMN:
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_MOVE_RIGHT_ONE_COLUMN:
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_DROP_CHIP:
        {
            if(m_presenter.IsCurrentPlayerABot())
            {
                UpdateChipMovedRightToTarget();
        ...
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_UNDO_DROP_CHIP:
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_REDO_DROP_CHIP:
        {
            break;
        }
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_MOVE_RIGHT_TO_TARGET:
        {
            m_controller.OnDown(m_presenter.GetGameViewActivePlayerChipColor(), m_presenter.GetBotTarget());
            break;
        }
        case cx::cmn::ui::BoardAnimationNotificationContext::POST_ANIMATE_REINITIALIZE_BOARD:
        {
            break;
        }
    }
...
void cx::cmn::ui::Gtkmm3GameView::Update(cx::cmn::ui::UserAction p_context, cx::cmn::ui::UserActionSubject* p_subject)
{
    IF_CONDITION_NOT_MET_DO(p_subject, return;);

    switch(p_context)
    {
        case cx::cmn::ui::UserAction::MOUSE_CLICKED:
        {
...
void cx::cmn::ui::Gtkmm3GameView::UpdateChipDropped()
{
    ...
    SyncPlayers();
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_MOVE_DROP_CHIP);
}
...
void cx::cmn::ui::Gtkmm3GameView::UpdateUndoChipDropped()
{
    ...
    SyncPlayers();
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_UNDO_DROP_CHIP);
}
...
void cx::cmn::ui::Gtkmm3GameView::UpdateRedoChipDropped()
{
    ...
    SyncPlayers();
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_REDO_DROP_CHIP);
}
...
{
    IF_CONDITION_NOT_MET_DO(m_board, return;);
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_MOVE_LEFT_ONE_COLUMN);
}

void cx::cmn::ui::Gtkmm3GameView::UpdateChipMovedRightOneColumn()
{
    IF_CONDITION_NOT_MET_DO(m_board, return;);
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_MOVE_RIGHT_ONE_COLUMN);
}

void cx::cmn::ui::Gtkmm3GameView::UpdateChipMovedRightToTarget()
{
    IF_CONDITION_NOT_MET_DO(m_board, return;);
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_MOVE_RIGHT_TO_TARGET);
}

void cx::cmn::ui::Gtkmm3GameView::UpdateGameResolved()
{
    IF_CONDITION_NOT_MET_DO(m_board, return;);
    Notify(cx::cmn::ui::BoardAnimationNotificationContext::ANIMATE_REINITIALIZE_BOARD);
}

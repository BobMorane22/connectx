...
class Gtkmm3OnSelectionChangedSignal : public cx::ui::cmn::ISignal<void>
{
...
cx::ui::cmn::Gtkmm3ColorPicker::Record::Record()
{
    add(m_color);
}

cx::ui::cmn::Gtkmm3ColorPicker::Gtkmm3ColorPicker(const std::vector<Color>& p_colors)
{
    ...
    set_cell_data_func(m_renderer, sigc::mem_fun(*this, &cx::ui::cmn::Gtkmm3ColorPicker::OnRenderCell));
...
void cx::ui::cmn::Gtkmm3ColorPicker::SetDelegate(std::unique_ptr<IWidget> p_delegate)
{
...
cx::ui::cmn::Color cx::ui::cmn::Gtkmm3ColorPicker::GetCurrentSelection() const 
{
    cx::ui::cmn::Color currentColor{0, 0, 0, 0}; // Transparent...
    ...
    if(INL_ASSERT(iter))
    {
        ...
        if(INL_ASSERT(row))
        {
            ...
            currentColor = cx::ui::cmn::Color{color.get_red_u(), color.get_green_u(), color.get_blue_u()};
        }
    }
...
void cx::ui::cmn::Gtkmm3ColorPicker::SetCurrentSelection(const cx::ui::cmn::Color& p_color) 
{
...
std::unique_ptr<cx::ui::cmn::ISignal<void>> cx::ui::cmn::Gtkmm3ColorPicker::OnSelectionChanged()
{
    return std::make_unique<Gtkmm3OnSelectionChangedSignal>(*this);
}

size_t cx::ui::cmn::Gtkmm3ColorPicker::GetWidth() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetWidth();
}

size_t cx::ui::cmn::Gtkmm3ColorPicker::GetHeight() const 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return 0u;);
    return m_delegate->GetHeight();
}

void cx::ui::cmn::Gtkmm3ColorPicker::SetEnabled(EnabledState p_enabled) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetEnabled(p_enabled);
}

void cx::ui::cmn::Gtkmm3ColorPicker::SetMargins(const Margins& p_newMarginSizes) 
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetMargins(p_newMarginSizes);
}

void cx::ui::cmn::Gtkmm3ColorPicker::SetTooltip(const std::string& p_tooltipContents)
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return;);
    m_delegate->SetTooltip(p_tooltipContents);
}

std::unique_ptr<cx::ui::cmn::ISignal<cx::ui::cmn::EventPropagation, cx::ui::cmn::KeyboardKeyPressedEvent>> cx::ui::cmn::Gtkmm3ColorPicker::OnKeyPressed()
{
    IF_CONDITION_NOT_MET_DO(m_delegate, return nullptr;);
    return m_delegate->OnKeyPressed();
}

void cx::ui::cmn::Gtkmm3ColorPicker::AddElement(const cx::ui::cmn::Color& p_color, bool p_setActive)
{
    IF_PRECONDITION_NOT_MET_DO(bool(m_treeModel), return;);
...
void cx::ui::cmn::Gtkmm3ColorPicker::OnRenderCell(const Gtk::TreeModel::const_iterator& iter)
{
    auto row = *iter;
    const Gdk::RGBA color = row[m_records.m_color];
...
void cx::ui::cmn::Gtkmm3ColorPicker::OnComboChanged()
{
    const cx::ui::cmn::Color currentColor = GetCurrentSelection();

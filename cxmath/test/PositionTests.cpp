...
{
    constexpr cx::math::Position position;
...
{
    constexpr cx::math::Position lhs{1.0, 2.0};
    constexpr cx::math::Position rhs{lhs.m_x, lhs.m_y};
...
{
    const cx::math::Position lhs{1.0, 2.0};

    // Testing a difference in x:
    constexpr cx::math::Position rhsDiffInX{lhs.m_x + 1.0, lhs.m_y};
    ASSERT_FALSE(lhs == rhsDiffInX);

    // Testing a difference in y:
    constexpr cx::math::Position rhsDiffInY{lhs.m_x, lhs.m_y + 1.0};
